...
3. **Resolve** — park the question/scope issues to the body (`cw-feedback:needs-input`); file umbrellas for cleared umbrella-sized issues; build + serial-merge the small ones over a quiescent default branch.
